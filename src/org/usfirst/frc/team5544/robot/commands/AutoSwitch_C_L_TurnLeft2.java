 ...
 *
 */
public class AutoSwitch_C_L_TurnLeft2 extends Command {

	public AutoSwitch_C_L_TurnLeft2() {
	...
	protected void execute() {
		Robot.DRIVELEFTPID.setSetpoint(500);
		Robot.DRIVERIGHTPID.setSetpoint(-500);
