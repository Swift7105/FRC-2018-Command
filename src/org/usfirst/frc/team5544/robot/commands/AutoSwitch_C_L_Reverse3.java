 ...
 *
 */
public class AutoSwitch_C_L_Reverse3 extends Command {
	double target = 10000;
	double error;
	boolean finished;

	public AutoSwitch_C_L_Reverse3() {
	...
	protected void execute() {
		finished = false;
		Robot.DRIVELEFTPID.setSetpoint(20000);
		Robot.DRIVERIGHTPID.setSetpoint(20000);
